    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=17, null=True, unique=True, validators=[django.core.validators.RegexValidator(message="شماره تلفن باید در فرمت صحیح وارد شود. مثال: '+989123456789'", regex='^\\+?1?\\d{9,15}$')], verbose_name='شماره تلفن')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name_fa', models.CharField(blank=True, max_length=50, null=True, verbose_name='نام (فارسی)')),
                ('last_name_fa', models.CharField(blank=True, max_length=50, null=True, verbose_name='نام خانوادگی (فارسی)')),
