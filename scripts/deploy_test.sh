...
# =============================================================================
# اسکریپت Deploy سیستم SSO برای تست
# مخصوص دامنه auth.avinoo.ir با SQLite
# =============================================================================
...
echo "=========================================="
echo "🚀 Deploy سیستم SSO برای تست"
echo "🌐 دامنه: $DOMAIN"
echo "🗄️  دیتابیس: SQLite"
echo "=========================================="
echo ""
...
# SQLite is used by default - no additional configuration needed
...
echo ""
echo "⚠️  نکات مهم:"
echo "   - این تنظیمات برای تست است"
echo "   - از SQLite استفاده می‌کند"
echo "   - برای production از PostgreSQL استفاده کنید"
echo "   - رمز عبور admin را تغییر دهید"
echo ""
echo "=========================================="
print_success "Deploy تست کامل شد! 🎉"
echo "=========================================="
